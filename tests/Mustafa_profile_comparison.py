...
omega = np.loadtxt("../vector_field_star_self_interacting/Lambda_0/Dim_4/f0_0.01/cA4_0.0/omega.dat")
...
#np.savetxt("../vector_field_star_self_interacting/Lambda_0/Dim_4/f0_0.01/cA4_0.0/factor.dat", popt2)
